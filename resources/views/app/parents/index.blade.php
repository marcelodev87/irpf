...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard', ['document' => session('document')]) }}">Página
                    Inicial</a></li>
            <li class="breadcrumb-item"><a
                    href="{{ route('declaration.year', ['document' => session('document'), $declaration->id]) }}">Declaração
                    - {{ $declaration->year }}</a></li>
